...
public:
	...
	Chunk *loader_enters_mesh_chunk(Object *loader, Vector3i chunk_idx);
	Chunk *loader_enters_collision_chunk(Object *loader, Vector3i chunk_idx);
	...
	PackedVector3Array set_points_and_update(PackedVector3Array global_idxs, PackedFloat32Array fullness_values, PackedByteArray material_values);
